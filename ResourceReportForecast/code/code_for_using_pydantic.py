...
class Type10(Enum):
    ResourceReportForecast = 'ResourceReportForecast'


class ResourceReportForecast(BaseModel):
    ...
    type: Optional[Type10] = Field(
        None, description='NGSI Entity type. It has to be ResourceReportForecast'
    )
